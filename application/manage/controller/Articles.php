...
//                    "a_type.in" => "选择的类型有误!~",
                ...
                if ($data['code'] === 1) {
                    ...
                    if(!isset($save_info['ac_parent_id_3']) || empty($save_info['ac_parent_id_3'])){
                        $save_info['ac_parent_id_3'] = '';
                    }
                    if(!isset($save_info['ac_parent_id_2']) || empty($save_info['ac_parent_id_2']) ){
                        $save_info['ac_parent_id_2'] = '';
                    }
...
//            }
            ...
            $second_cate = $this->ac->getList(['ac_parent_id' => $info['parent_1']]);
            $third_cate = 0;
